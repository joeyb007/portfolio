...
- **Pick your mode.** After the reveal, choose **Minimalistic** (a one-page, Notion-style summary with the brain parked to the side and chat kept) or **Animated** (the full 3D experience). The choice is remembered; `?mode=minimalistic` or `?mode=animated` in the URL overrides it. Phones always get the summary.
